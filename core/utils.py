...
def draw_bbox_by_classes(image, bboxes, classesName: str, show_label=True):
  try:
    classesFilepath = cfg.YOLO.MYCLASSES[classesName]["namesPath"]
    classNames = read_class_names(classesFilepath)
    return draw_bbox(image, bboxes, classNames, show_label=True)
